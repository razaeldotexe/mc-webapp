...
import { LayoutDashboard, Upload, FolderOpen, Settings, Box, Globe, LogOut } from 'lucide-react';
    ...
    return (
        <aside className="sidebar">
            ...
            <nav className="sidebar-nav">
                ...
                <span className="sidebar-section-title" style={{ marginTop: '12px' }}>Lainnya</span>
            ...
            <div className="sidebar-footer">
                <button onClick={handleLogout} className="nav-link" style={{ width: '100%', cursor: 'pointer', border: 'none', background: 'transparent', color: 'var(--danger)', fontFamily: 'inherit' }}>

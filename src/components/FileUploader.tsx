        ...
        <div>
            ...
            {error && (
                <div className="notification notification-error">
                    <AlertCircle size={18} />
                    <span>{error}</span>
                    <button onClick={() => setError('')} className="btn btn-ghost btn-icon btn-sm" style={{ marginLeft: 'auto' }}>
                        <X size={14} />
                    </button>
                </div>
            )}
            ...
            {!file ? (
                ...
                <div className="card" style={{ marginBottom: '20px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <button onClick={removeFile} className="btn btn-ghost btn-icon" disabled={uploading}>
                            <X size={18} />
                        </button>
                    </div>
                </div>
                    ...
                    <div className="form-group">
                        ...
                        {thumbnailPreview ? (
                            <div className="thumbnail-preview">
                                ...
                                <button className="thumbnail-preview-remove" onClick={removeThumbnail} disabled={uploading}>
                                    <X size={14} />
                                </button>
                            </div>
                        ) : (
                        ...
                        <input
                            ...
                            onChange={(e) => e.target.files?.[0] && selectThumbnail(e.target.files[0])}
                            style={{ display: 'none' }}
                        />
                    </div>
